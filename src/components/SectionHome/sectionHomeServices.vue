...
<section class="section-services">
  ...
  <button  v-inview class="btn reveal up">Services</button>
     ...
     <ResponsiveImage 
      name="services/Services-1" 
      alt="Webentwicklung-Service bei Valentin & Enkel" 
      className="s-image-1 reveal left" v-inview
      sizes="10vw"/>
       <ResponsiveImage
      name="services/Services-2" 
      alt="Webentwicklung-Service bei Valentin & Enkel" 
      className="s-image-2 reveal left" v-inview
      sizes="10vw"/>
       <ResponsiveImage
      name="services/Services-3" 
      alt="Webentwicklung-Service bei Valentin & Enkel" 
      className="s-image-3 reveal left" v-inview
      sizes="10vw"/>
...
.line-w.animate {
  ...
  animation-delay: 0.2s; /* optional kleine Verzögerung */
}
...
@keyframes drawLine {
  ...
  to {
    height: 100%;              /* Von 30% bis 100% = 70% Länge */
  }
}
...
@keyframes drawLine-w {
  from {
    left: 50%;                /* Start mit 0 Höhe */
    width: 0px;
  }
  to {
    left: 0;
    width: 100%;              /* Von 30% bis 100% = 70% Länge */
  }
}
